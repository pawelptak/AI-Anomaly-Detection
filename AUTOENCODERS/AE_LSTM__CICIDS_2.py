...
from Model.AutoEncoderModelLSTM import AutoEncoderModelLSTM_3
...
model = AutoEncoderModelLSTM_3(df.shape[2], WINDOW_SIZE, UNITS)
...
analyzer.feed(error, y_label, best_threshold,
              max_f1_score, f'DDoS/LSTM_OP_1_{WINDOW_SIZE}', f'DDoS, LSTM layers = [80, 50, 20], [50, 80]')
